...
variable "private_key_name" {
  type    = string
  default = "backend_ec2_key"
}

variable "private_key_file_name" {
  type    = string
  default = "backend_ec2_key.pem"
}
...
variable "codedeploy_application_name" {
  type    = string
  default = "tf-backend-service-codedeploy"
}
...
variable "codepipeline_name" {
  type    = string
  default = "tf-backend-service-pipeline"
}

variable "codepipeline_bucket_name" {
  type    = string
  default = "tf-backend-service-s3"
}
...
variable "codepipeline_repo_id" {
  type    = string
  default = "changchiajung/djangoTemplate"
}
